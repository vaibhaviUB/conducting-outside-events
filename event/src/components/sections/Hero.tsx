  ...
  <section className="relative min-h-screen flex items-center pt-24 pb-16 px-4">
    <div className="container mx-auto">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h1 className="mt-6 font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold tracking-tight leading-[1.05] animate-fade-in-up">
          Relax. Refresh.
          <br />
          <span className="text-gradient">Reconnect.</span>
        </h1>

        <p className="mt-6 mx-auto max-w-2xl text-base sm:text-lg text-muted-foreground animate-fade-in-up" style={{ animationDelay: "0.15s" }}>
