    ...
    >
      <div className="flex items-center justify-between px-4 py-3 md:px-6">
        <Link to="/" className="flex items-center gap-2 group">
          <span className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-aurora animate-aurora" style={{ backgroundSize: "200% 200%" }}>
            <Brain className="h-5 w-5 text-white" />
            <span className="absolute inset-0 rounded-xl shadow-glow opacity-60 group-hover:opacity-100 transition" />
          </span>
